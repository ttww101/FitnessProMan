...
//        GAManager.createNormalScreenEventWith("ScoreViewController")
...
// MARK: - healthKit
    ...
    @IBAction func finishBtn(_ sender: UIButton) {
        ...
        Analytics.logEvent("ScoreViewController_finishBtn", parameters: nil)
...
extension ScoreViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        if let cell = scoreCollectionView.dequeueReusableCell(withReuseIdentifier: "scoreCollectionViewCell",
                                                              for: indexPath) as? ScoreViewCell {
            
            let scoreArray = LocaolDatabase.instance.getScoreArray()[indexPath.row]
            
            cell.updateView(scoreModel: ScoreViewCellModel(scoreModel: scoreArray))
...
extension ScoreViewController: UICollectionViewDelegate, UIScrollViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let cell = self.scoreCollectionView.cellForItem(at: indexPath) as? ScoreViewCell  else {return}
